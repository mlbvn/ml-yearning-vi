...
Để kết nối điều này với những định nghĩa trước kia, Độ chệch tránh được và Độ chệch liên hệ với nhau như sau: [9]
...
[8] Nếu con số này là âm, bạn đang làm tốt hơn ở trên tập huấn luyện so với tỉ lệ lỗi tối ưu. Điều này có nghĩa là bạn đang overfitting tập huấn luyện và thuật toán đã ghi nhớ quá mức tập huấn luyện. Bạn nên tập trung vào các phương pháp giảm phương sai hơn là các phương pháp giảm độ chệch sâu xa hơn.

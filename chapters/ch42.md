...
Giả sử bạn đã phát triển một hệ thống nhận dạng giọng nói hoạt động rất tốt  trên tập huấn luyện và trên tập huấn luyện - phát triển. Tuy nhiên, hệ thống đó lại hoạt động kém trên tập phát triển: Bạn có vấn đề về dữ liệu không tương đồng. Bạn có thể làm gì?
...
Ví dụ, giả sử bạn thực hiện phân tích lỗi nhận dạng giọng nói trên tập phát triển: Bạn duyệt qua 100 mẫu một cách thủ công và cố gắng hiểu xem thuật toán đang phạm lỗi ở những đâu. Bạn phát hiện rằng hệ thống của bạn thực thi kém vì hầu hết những đoạn âm thanh trong tập phát triển được thu trong ô tô, trong khi hầu hết các ví dụ để huấn luyện được thu trên một nền yên tĩnh. Tiếng ồn từ động cơ và đường phố làm ảnh hưởng nghiêm trọng đến chất lượng của hệ thống của bạn. Trong trường hợp này, bạn có thể cố gắng thu thập thêm dữ liệu huấn luyện bao gồm những đoạn âm thanh được thu trong ô tô. Mục đích của việc phân tích lỗi là để hiểu những khác biệt đáng kể giữa tập huấn luyện và tập phát triển, vốn là nguyên nhân dẫn đến dữ liệu không tương đồng.
...
Nếu tập huấn luyện và tập huấn luyện-phát triển của bạn chứa những đoạn audio thu trong ô tô, bạn nên kiểm tra kĩ lưỡng chất lượng của hệ thống của bạn trên tập con dữ liệu này. Nếu hệ thống hoạt động tốt với dữ liệu ô tô trong tập huấn luyện nhưng không tốt với dữ liệu ô tô trong tập huấn luyện-phát triển, điều đó càng khẳng định giả thuyết rằng thu thập thêm dữ liệu ô tô sẽ có ích. Đó là lí do tại sao chúng ta thảo luận trong chương trước về khả năng thêm một số dữ liệu lấy từ tập phát triển/tập kiểm tra với cùng phân phối vào trong dữ liệu huấn luyện của bạn. Làm như vậy cho phép bạn so sánh chất lượng [hệ thống] trên tập huấn luyện so với trên tập phát triển/kiểm tra.
...
Thật không may, không có một sự bảo đảm nào trong quá trình này. Ví dụ, nếu ban không có cách nào để có thể có thêm dữ liệu huấn luyện tương đồng với dữ liệu trong tập phát triển, bạn có thể không có được một lộ trình rõ ràng nào hướng đến cải thiện chất lượng hệ thống.
...
[14] Cũng có một số nghiên cứu về "thích nghi theo miền" -- làm sao để huấn luyện một giải thuật trên một phân phối và để nó tổng quát hóa trên một phân phối khác. Những phương pháp này thường chỉ ứng dụng được với một số loại vấn đề đặc biệt, và ít được sử dụng hơn nhiều so với những ý tưởng đã được trình bày trong chương này.
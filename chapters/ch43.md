...
Hệ thống nhận diện giọng nói của bạn cần dữ liệu những âm thanh được lấy từ trong xe hơi. Thay vì thu thập nhiều dữ liệu trong khi lái xe xung quanh, có thể có một cách làm dễ dàng hơn để có được dữ liệu này: Bằng cách tổng hợp một cách nhân tạo.
...
Giả sử bạn có một số lượng lớn clip âm thanh tiếng ồn xe hơi/đường phố. Bạn có thể tải dữ liệu này từ một số trang web. Giả sử bạn cũng có một tập huấn luyện lớn của tiếng người đang nói trong một căn phòng yên tĩnh. Nếu bạn lấy clip âm thanh của một người đang nói và "thêm" vào một đoạn clip âm thanh tiếng ồn xe hơi/đường phố, bạn sẽ có được một đoạn clip âm thanh như thể người đó đang nói trong một chiếc xe ồn ào. Sử dụng quy trình này, bạn có thể "tổng hợp" lượng dữ liệu khổng lồ như thể nó được thu thập bên trong một chiếc xe hơi.
...
Tổng quát hơn, có một số trường hợp mà trong đó tổng hợp dữ liệu nhân tạo cho phép bạn tạo một tập dữ liệu khổng lồ phù hợp với tập phát triển. Hãy sử dụng bộ nhận diện ảnh mèo làm ví dụ thứ hai. Bạn nhận thấy rằng những ảnh của tập phát triển hay bị mờ chuyển động nhiều hơn bởi vì chúng có xu hướng đến từ người dùng điện thoại di động hơi di chuyển điện thoại của họ trong khi chụp ảnh. Bạn có thể lấy những ảnh không bị mờ từ tập huấn luyện của ảnh internet, và thêm vào mô phỏng của hiệu ứng mờ chuyển động cho chúng, do đó làm cho chúng giống với tập phát triển hơn.
...
Hãy nhớ rằng tổng hợp dữ liệu nhân tạo có những thách thức của nó: đôi khi dễ dàng tạo ra dữ liệu tổng hợp có vẻ giống thật với một người hơn là tạo dữ liệu có vẻ giống thật với máy tính. Ví dụ: giả sử bạn có 1.000 giờ dữ liệu huấn luyện giọng nói, nhưng chỉ có một giờ tiếng ồn xe hơi. Nếu bạn liên tục sử dụng cùng một giờ tiếng ồn xe hơi với các phần khác nhau từ 1.000 giờ dữ liệu huấn luyện ban đầu, bạn sẽ nhận được với một tập dữ liệu tổng hợp trong đó tiếng ồn xe hơi giống nhau lặp đi lặp lại. Mặc dù một người nghe âm thanh này có thể sẽ không thể phân biệt-tất cả tiếng ồn của xe hơi đều giống nhau với hầu hết chúng ta-nhưng có thể thuật toán học sẽ "overfit" một giờ tiếng ồn của xe hơi đó. Do đó, nó có thể khái quát kém đến một clip âm thanh mới với tiếng ồn xe hơi khác đi.
...
Ngoài ra, giả sử bạn có 1.000 giờ tiếng ồn ô tô riêng rẽ, nhưng tất cả đều được lấy từ chỉ 10 chiếc xe khác nhau. Trong trường hợp này, thuật toán có thể "overfit" 10 chiếc xe này và đạt chất lượng kém nếu được thử nghiệm trên âm thanh từ một chiếc xe khác. Thật không may, những vấn đề này có thể khó phát hiện.
...
Lấy một ví dụ nữa, giả sử bạn đang xây dựng một hệ thống thị giác máy tính để nhận diện xe hơi. Giả sử bạn hợp tác với một công ty sản xuất trò chơi video có mô hình đồ họa máy tính của một số xe hơi. Để huấn luyện thuật toán của bạn, bạn sử dụng các mô hình để tạo ra hình ảnh tổng hợp của xe hơi. Ngay cả khi các hình ảnh tổng hợp trông rất giống thật, phương pháp này (đã được nhiều người độc lập đề xuất) có thể sẽ không hoạt động tốt. Trò chơi video có thể có ~20 thiết kế xe hơi trong toàn bộ trò chơi. Nó rất tốn kém để xây dựng một mô hình xe hơi 3D của một chiếc xe hơi; Nếu bạn đang chơi game, có lẽ bạn sẽ nhận thấy rằng bạn đang nhìn thấy những chiếc xe giống nhau lặp đi lặp lại, có lẽ chỉ được sơn khác nhau. Tức là, dữ liệu này trông rất giống thật với bạn. Nhưng so với tập hợp tất cả các xe ô tô trên đường phố (hay những gì bạn có thể thấy trong tập phát triển/kiểm tra), bộ 20 chiếc xe được tổng hợp này chỉ chiếm một phần rất nhỏ trong phân phối xe hơi thế giới. Do đó, nếu 100.000 mẫu huấn luyện của bạn đều đến từ 20 chiếc xe này, hệ thống của bạn sẽ "overfit" với 20 thiết kế xe cụ thể này và sẽ không thể khái quát tốt cho các tập phát triển/kiểm tra bao gồm các thiết kế xe khác.

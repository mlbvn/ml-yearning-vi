...
Cách biệt về khả năng xác định xe giữa con người và phần thuật toán xác định xe

> 2. How far is the Detect pedestrians component from human-level performance?

Cách biệt về khả năng phát hiện người đi bộ giữa thuật toán và con người

...
3. Cách biệt giữa khả năng của toàn hệ thống và con người tới cỡ nào? Đối với con người, chúng ta giả định rằng con người tính đường đi cho xe mà chỉ dựa vào kết quả đầu ra của hai pipeline trước đó (thay vi dựa vào hình ảnh camera). Nói cách khác, với cùng thông tin đầu, khả năng ước lượng đường đi của thuật toán so với con người sẽ như thế nào?

...
3. Cách biệt của toàn hệ thống và con người? Ở đây, con người phải hoạch định một con đường cho chiếc xe từ đầu ra của hai pipeline trước đó (không phải truy cập vào hình ảnh). Nói cách khác, so sánh hiệu suất của phần pipeline hoạch định đường đi so với con người, khi cả hai được cung cấp cùng một đầu vào?

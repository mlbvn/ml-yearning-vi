...
Điều này cho bạn biết rằng bạn có độ chệch cao (có thể tránh được) trên tập huấn luyện. Tức là, thuật toán đang hoạt động kém trên tập huấn luyện. Kỹ thuật giảm độ chệch sẽ có ích trong trường hợp này.
...
Trong hai ví dụ trên, thuật toán chỉ có vấn đề về độ chệch cao (có thể tránh được) hoặc phương sai cao. Một thuật toán có thể mắc phải một hoặc nhiều vấn đề về độ chệch cao (có thể tránh được), phương sai cao hoặc dữ liệu không tương đồng. Ví dụ như:
...
Thuật toán này có độ chệch cao (có thể tránh được) và lỗi dữ liệu không tương đồng. Tuy nhiên, nó không có vấn đề phương sai cao trong phân phối tập huấn luyện.

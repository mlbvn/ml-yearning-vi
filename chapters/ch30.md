...
Như chúng ta đã thảo luận, nếu đường cong sai số của tập phát triển đi vào trạng thái phẳng và ổn định, việc chỉ thêm dữ liệu sẽ khó có thể đem về hiệu suất ta mong đợi.
...
Đường cong màu đỏ thể hiện sai số tập phát triển (màu đỏ) thường cao hơn so với đường cong thể hiện sai số tập huấn luyện (màu xanh). Vì vậy, hầu như không có cách nào việc thêm dữ liệu sẽ khiến cho đường cong sai số màu đỏ giảm xuống mức hiệu suất mong muốn khi ngay cả sai số huấn luyện cũng cao hơn mức mong muốn đó.
...
Đánh giá cả đường cong sai số của tập phát triển lẫn đường cong sai số của tập huấn luyện trên cùng một biểu đồ giúp những ngoại suy về đường cong sai số tập phát triển có độ tin cậy cao hơn. 

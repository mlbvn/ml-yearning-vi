...
Đường cong thể hiện sai số tập phát triển (màu đỏ) thường cao hơn so với đường cong thể hiện sai số tập huấn luyện (màu xanh). Vì vậy, hầu như không có cách nào việc thêm dữ liệu sẽ khiến cho đường cong sai số tập phát triển (màu đỏ) giảm xuống mức hiệu suất mong muốn khi ngay cả sai số huấn luyện cũng cao hơn mức mong muốn đó.

...
Bạn đang làm về nhận dạng giọng nói và bạn có một tập dữ liệu âm thanh. Giả sử, tập dữ liệu của bạn có nhiều âm thanh nhiễu mà thậm chí con người còn mắc phải 10% lỗi. Giả sử, hệ thống của bạn đã đạt được 8% lỗi. Bạn có thể sử dụng bất kỳ kỹ thuật nào trong ba kỹ thuật được mô tả trong Chương 33 để tiếp tục tiến bộ nhanh chóng?
...
1. Bạn vẫn có thể nhận được bảng ghi từ con người với chất lượng cao hơn so với đầu ra thuật toán của bạn.
...
Tổng quát hơn, miễn là có các mẫu về tập phát triển mà con người đúng và thuật toán của bạn sai, thì nhiều kỹ thuật được mô tả trước đây sẽ áp dụng được. Điều này đúng ngay cả khi, tính trung bình trên toàn bộ tập phát triển/kiểm tra, chất lượng của bạn đã vượt qua chất lượng ở cấp độ con người.
...
Có nhiều ứng dụng học máy quan trọng trong đó máy móc vượt qua chất lượng của con người. Ví dụ, máy móc tốt hơn trong việc dự đoán xếp hạng phim, sẽ mất bao lâu để một chiếc xe giao hàng lái xe đi đâu đó, hoặc có chấp nhận đơn xin vay tiền hay không. Chỉ một tập con những kỹ thuật là áp dụng được khi mà con người còn gặp khó khăn trong việc xác định các mẫu nào mà thuật toán còn rõ ràng đang làm sai. Do đó, tiến độ thường chậm hơn đối với các vấn đề trong đó máy móc đã vượt qua chất lượng ở cấp độ con người, trong khi tiến độ nhanh hơn khi máy móc vẫn đang cố gắng bắt kịp con người.

...
--> Người dùng của ứng dụng ảnh mèo(?) đã đăng tải 10.000 tấm ảnh mà bạn đã gán nhãn chúng có mèo hay không một cách thủ công. Bạn cũng có một tập ảnh lớn hơn gồm 200.000 tấm mà bạn đã tải về trên mạng. Bạn nên tạo tập huấn luyện/phát triển/kiểm tra như thế nào?
...
--> Vì 10.000 tấm ảnh của người dùng phản ánh gần với phân bố xác suất thật của dữ liệu mà bạn muốn làm tốt trên nó, bạn có thể sử dụng chúng cho tập phát triển và kiểm tra. Nếu bạn đang huấn luyện một thuật toán deep-learning đói dữ liệu, bạn có thể đưa thêm 200.000 tấm ảnh trên mạng cho việc huấn luyện. Do vậy, tập huấn luyện và tập phát triển/kiểm tra sẽ đến từ những phân phối khác nhau. Việc này ảnh hưởng thế nào tới công việc của bạn?
...
--> Thay vì phân chia dữ liệu của chúng ta ra thành tập huấn luyện/phát triển/kiểm tra, chúng ta nên lấy hết 210.000 tấm ảnh mà ta có, và gửi chúng một cách ngẫu nhiên vào tập huấn luyện/phát triển/kiểm tra. Trong trường hợp này, tất cả dữ liệu đều đến từ cùng một phân phối. Nhưng tôi không ủng hộ phương pháp này, bởi vì khoảng 205.000/210.000 ≈ 97,6% dữ liệu phát triển/kiểm tra đến từ những ảnh trên mạng nên nó không phản ánh được phân phối thật mà bạn muốn làm tốt trên nó. Hãy nhớ lời khuyên khi chọn tập phát triển/kiểm tra:
...
--> Đa số các tài liệu học thuật về machine learning đều mặc định tập huấn luyện, tập phát triển và tập kiểm tra đều đến từ cùng một phân phối [11]. Trong những ngày đầu của machine learning, dữ liệu rất là hạn hẹp. Ta thường chỉ có một bộ dữ liệu được lấy ra từ một vài phân bố xác suất. Nên ta thường phân tách một cách ngẫu nhiên dữ liệu đó thành tập huấn luyện/phát triển/kiểm tra, và việc mặc định là tất cả các dữ liệu đến từ cùng một nguồn thường được thỏa mãn.
...
--> Hãy xem xét một ví dụ thứ hai. Giả sử bạn đang xây dựng một hệ thống nhận diện giọng nói để phiên âm địa chỉ đường cho một ứng dụng di động/ứng dụng định vị bằng giọng nói. Bạn có 20.000 mẫu của người dùng đang nói địa chỉ đường. Nhưng bạn cũng có 500.000 mẫu từ những bản ghi âm khác về người dùng đang nói về những chủ đề khác. Bạn có thể lấy 10.000 mẫu về địa chỉ đường cho tập phát triển/kiểm tra, và sử dụng 10.000 mẫu còn lại, cộng thêm 500.000 mẫu, cho việc huấn luyện.
...
--> Chúng ta sẽ tiếp tục mặc định rằng dữ liệu phát triển và dữ liệu kiểm tra của bạn đến từ cùng một phân phối. Nhưng việc hiểu rằng phân bố tập huấn luyện và phát triển/kiểm tra khác nhau sẽ dẫn tới một vài khó khăn đặc biệt là rất quan trọng.
...
--> [11] Có một vài nghiên cứu khoa học về việc huấn luyện và kiểm tra trên các phân phối khác nhau. Những ví dụ bao gồm "domain adaptation", "học chuyển tiếp" và "multitask learning". Nhưng vẫn có một khoảng cách lớn giữa lý thuyết và thực hành. Nếu bạn huấn luyện trên bộ dữ liệu A và kiểm tra trên một vài kiểu dữ liệu rất khác B, may mắn sẽ có ảnh hưởng rất lớn tới việc thuật toán của bạn hoạt động tốt thế nào. (Ở đây, "may mắn" bao gồm những đặc trưng được tạo thủ công của người làm nghiên cứu, cũng như mà một vài nhân tố khác mà chúng ta vẫn chưa hiểu rõ.) Điều này làm cho nghiên cứu khoa học của việc huấn luyện và kiểm tra trên những phân phối khác nhau khó có thể hoàn thành theo một cách có hệ thống.

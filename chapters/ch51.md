...
Mỗi tác vụ trong số này là một bài toán phân loại ảnh nhị phân: Bạn phải có một bức ảnh đầu vào, và cho ra hoặc 0 hoặc 1. Nhưng những tác vụ đầu tiên trong danh sách này có vẻ "dễ" hơn nhiều để một mạng neural có thể học. Bạn sẽ có thể huấn luyện những tác vụ này với ít mẫu huấn luyện hơn.

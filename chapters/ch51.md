...
Mỗi trong số các tác vụ này là một bài toán phân loại ảnh nhị phân: Bạn phải có một bức ảnh đầu vào, và cho ra hoặc 0 hoặc 1. Nhưng những tác vụ đầu tiên trong danh sách này có vẻ "dễ" hơn nhiều để một mạng neural có thể học. Bạn sẽ có thể huấn luyện những tác vụ này với ít mẫu huấn luyện hơn.
...
Nếu bạn có thể lấy một tác vụ phức tạp, và chia nhỏ nó thành những tác vụ con đơn giản hơn, sau đó viết mã nguồn cụ thể cho từng tác vụ con, bạn đang cung cấp cho thuật toán một kiến thức tiền đề giúp nó học một tác vụ hiệu quả hơn.
...
nằm ngoài phạm vi của chương này. Tham khảo khóa "Deep Learning specialization" trên Coursera (http://deeplearning.ai) nếu bạn muốn học thêm về thuật toán này.

...
Giả sử bạn muốn xây dựng một hệ thống để kiểm tra đánh giá phản hồi của sản phẩm trực tuyến và tự động cho biết liệu người viết có thích sản phẩm đó hay không. Ví dụ, bạn muốn hệ thống phân đó loại phản hồi dưới đây là tích cực:

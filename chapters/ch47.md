...
Bài toán về nhận dạng các quan điểm tích cực và tiêu cực được gọi là "phân loại cảm xúc". Để xây dựng hệ thống này, bạn có thể tạo "đường dẫn" bao gồm hai thành phần:
...
Chúng ta có thể hình dung "đường dẫn" của hai thành phần này như sau:
...
Xu hướng gần đây đó là thay đổi hệ thống đường dẫn với một thuật toán duy nhất. Một **thuật toán đầu cuối** cho tác vụ này sẽ đơn giản là thu thập văn bản gốc "Cây lau nhà này thật tuyệt!", và cố gắng nhận dạng trực tiếp cảm xúc từ nó:

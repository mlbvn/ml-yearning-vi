...
Giả sử thuật toán của bạn dịch ra một bản không chính xác *E*<sub>out</sub> thay vì một bản dịch chính xác E\* nào đó. Sau đó, bài kiểm tra xác minh tối ưu sẽ yêu cầu bạn tính toán xem liệu Điểm<sub>C</sub>(*E\**) > Điểm<sub>C</sub>(*E*<sub>out</sub>) hay không. Nếu bất đẳng thức này đúng thì cách tính Điểm<sub>C</sub>(.) đã nhận dạng chính xác E\* có điểm cao hơn so với *E*<sub>out</sub>; do đó, bạn sẽ gán lỗi này cho thuật toán tìm kiếm gần đúng. Ngược lại, bạn gán lỗi này cho cách tính Điểm<sub>C</sub>(.)
...
Đây là một “mẫu thiết kế” rất phổ biến trong AI khi học một hàm tính điểm gần đúng Điểm<sub>\*</sub>(.), sau đó sử dụng một thuật toán tối đa xấp xỉ. Nếu bạn có thể phát hiện ra kiểu mẫu này, bạn sẽ có thể sử dụng bafi kieerm tra xác minh tối ưu để hiểu nguồn gốc lỗi của mình.

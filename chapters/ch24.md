...
Bạn có thể đã nghe nói về "sự đánh đổi giữa Độ chệch và Phương sai". Trong các thay đổi thể thực hiện đối với hầu hết các thuật toán học, có một vài cách giảm sai số độ chệch nhưng với phải trả giá bằng gia tăng phương sai và ngược lại. Đây là sự "đánh đổi" giữa độ chệch và phương sai.
...
Ví dụ việc tăng kích thước mô hình của bạn -- như thêm các neurons/tầng trong mạng nơ-ron hoặc thêm các đầu vào đặc trưng -- nhìn chung sẽ giảm độ chệch nhưng có thể làm tăng phương sai. Một cách khác, thêm điều chuẩn thường làm tăng độ chệch nhưng giảm phương sai.

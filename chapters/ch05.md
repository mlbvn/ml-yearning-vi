...
=======
->
Khi bạn chưa triển khai ứng dụng di động, bạn chưa có người dùng nào cả, nên việc có thể có được dữ liệu phản ánh chính xác dữ liệu tương lai là rất khó. Nhưng bạn có thể thử làm gần giống nó. Ví dụ như bạn có thể hỏi bạn bè của mình để chụp những bức ảnh mèo bằng điện thoại và gửi cho bạn. Một khi ứng dụng được triển khai, bạn có thể cập nhật tập phát triển/kiểm tra sử dụng những dữ liệu người dùng thực tế.
>>>>>>> sửa lại bản dịch chap 5
...
=======
Nếu bạn thực sự không có cách nào để có được dữ liệu gần giống với dữ liệu trong tương lai, có lẽ bạn có thể sử dụng ảnh từ các trang web. Nhưng bạn cũng nên đề phòng các nguy cơ có thể dẫn đến việc hệ thống không khái quát hóa tốt.
>>>>>>> sửa lại bản dịch chap 5

...
Trước kỷ nguyên big data, có một nguyên tắc chung trong học máy là chia tập huấn luyện và kiểm tra ngẫu nhiên theo tỉ lệ 70%/30%. Cách chia này có thể dùng được, nhưng không phải là một ý tưởng tốt trong ngày càng nhiều ứng dụng nơi mà phân phối của tập huấn luyện (ảnh trên mạng trong ví dụ trên đây) khác với phân phối mà bạn thực sự quan tâm (ảnh chụp từ điện thoại).

...
| :-------:  | :-------:          | :-------:          | :-------:          | :-------:                                  |
| 1          | :heavy_check_mask: |                    |                    | Chó pitbull có màu lạ                      |
| 2          |                    |                    | :heavy_check_mask: |                                            |
| 3          |                    | :heavy_check_mask: | :heavy_check_mask: | Ảnh sư tử chụp ở sở thú trong một ngày mưa |
| 4          |                    | :heavy_check_mask: |                    | Một con báo bị khuất sau cây               |
| **Tổng %** | 25%                | 50%                | 50%                |                                            |

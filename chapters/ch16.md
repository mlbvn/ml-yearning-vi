...
->
Giả sử bạn tiếp tục cải thiện bộ phân loại mèo và đạt được những hiệu quả sau:
...
->
30% lỗi của bạn đến từ những ảnh bị gán nhãn nhầm trong tập phát triển, việc này thêm vào một lượng đáng kể lỗi vào các đánh giá độ chính xác của bạn. Trong trường hợp này, để cải thiện chất lượng của các nhãn trong tập phát triển là một việc đáng làm. Xử lý những mẫu bị gán nhãn nhầm sẽ giúp bạn biết được lỗi của bộ phân loại gần với 1.4% hay 2%—một sự khác biệt đáng kể.

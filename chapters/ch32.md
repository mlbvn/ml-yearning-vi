...
* Nếu tập huấn luyện của bạn bị lệch về một lớp, hoặc nếu nó có nhiều lớp, hãy chọn một tập hợp con “cân bằng” thay vì 10 mẫu huấn luyện ngẫu nhiên trong số 100 mẫu. Ví dụ, bạn có thể chắc chắn rằng 2/10 các mẫu là các mẫu dương và 8/10 là âm. Tổng quát hơn, bạn có thể đảm bảo tỷ lệ các mẫu từ mỗi lớp càng gần với tỉ lệ tổng cộng trong tập huấn luyện ban đầu.
...
Tôi sẽ không quan tâm với một trong những kỹ thuật này trừ khi bạn đã thử vẽ các đồ thị quá trình học và kết luận rằng các đồ thị quá nhiễu để nhìn thấy các xu hướng cơ bản. Nếu tập huấn luyện của bạn có quy mô lớn, ví dụ hơn 10.000 mẫu, và phân phối lớp của bạn không bị sai lệch, có lẽ bạn không cần các kỹ thuật này.
...
[10] Ở đây, việc lấy mẫu *thay thế* có nghĩa là: Bạn sẽ chọn ngẫu nhiên 10 mẫu khác nhau trong số 100 để tạo thành tập huấn luyện đầu tiên của mình. Sau đó, để hình thành tập huấn luyện thứ hai, bạn sẽ lại chọn 10 mẫu, nhưng không tính đến những gì đã được chọn trong tập huấn luyện đầu tiên. Vì vậy, có thể một mẫu cụ thể xuất hiện trong cả tập huấn luyện thứ nhất và thứ hai. Ngược lại, nếu bạn lấy mẫu *không thay thế*, tập huấn luyện thứ hai sẽ chỉ được chọn từ 90 mẫu không được chọn ở lần đầu tiên. Trong thực tế, sử dụng lấy mẫu thay thế hoặc không thay thế không tạo ra sự khác biệt lớn, nhưng lấy mẫu thay thế là cách làm phổ biến.

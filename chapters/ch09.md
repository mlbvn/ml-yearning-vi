...
Đây là một cách khác để kết hợp nhiều phép đánh giá lại.
...
Thay vào đó, bạn có thể làm như sau: Trước hết hãy định nghĩa thời gian chạy như thế nào là "chấp nhận được". Ta giả sử mốc dưới 100ms là chấp nhận được. Sau đó hãy cực đại hóa độ chính xác, với ràng buộc là bộ phân loại vẫn đảm bảo yêu cầu về thời gian chạy. Ở đây, thời gian chạy là một "phép đo thỏa mãn" —- bộ phân loại của bạn chỉ cần "đủ tốt" trên thang đo đấy, tức chỉ tốn tối đa 100ms để chạy xong. Độ chính xác mới là "phép đo để tối ưu".

...
->
* Bộ dev của bạn phải đủ lớn để phát hiện các thay đổi có ý nghĩa về độ chính xác của thuật toán của bạn, nhưng không nhất thiết phải lớn hơn nhiều. Bộ kiểm tra của bạn phải đủ lớn để cung cấp cho bạn ước tính tự tin về hiệu suất cuối cùng của hệ thống.
